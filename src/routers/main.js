...
const [id,setId]=useState('')
   useEffect(()=>{
       ...
       navigate('/')
       fetch('https://taskappbackend-ik2h.onrender.com/tasks/me',{
...
function logout(){
    ...
    if(con){
        fetch('https://taskappbackend-ik2h.onrender.com/users/logout',{
...
function finaledit(e){
    ...
    console.log(value)
    fetch(`https://taskappbackend-ik2h.onrender.com/taasks/${id}`,{
...
function deletetodo(e){
  fetch(`https://taskappbackend-ik2h.onrender.com/tasks/${e.target.id}`,{
...
function logoutall(){
    ...
    if(con){
        fetch('https://taskappbackend-ik2h.onrender.com/users/logoutAll',{
            method:'post',headers:{ "Content-Type": "application/json","Authorization":`${localStorage.getItem('token')}`},
        }).then(data=>{
            localStorage.removeItem('token')
            navigate('/')
...
function deleted(){
    ...
    if(con){
        fetch('https://taskappbackend-ik2h.onrender.com/users/me',{
   ...
   function handler(e){
       ...
       fetch('https://taskappbackend-ik2h.onrender.com/tasks',{
           method:'post',headers:{ "Content-Type": "application/json","Authorization":`${localStorage.getItem('token')}`},
